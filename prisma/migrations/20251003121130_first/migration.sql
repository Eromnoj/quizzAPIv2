...
CREATE TABLE `Quiz` (
    ...
    `difficulty` ENUM('facile', 'difficile', 'normal') NOT NULL,
...
-- AddForeignKey
ALTER TABLE `Recovery` ADD CONSTRAINT `Recovery_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `User`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
